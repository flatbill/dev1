...
exports.handler = async (event, context) => {
  console.log('7 running Netlify lambda function: delSupabaseMulti')
  ...
  let fld4 = ''
  let fld4v = ''
  console.log('10 delSupabaseMulti qsParms and tbl:')
  console.table(qsParms)
  console.table(tbl)
  console.log('13  delSupabaseMulti')
  let myTxt = '{'
  let dq = '"'
  let ii = 1
  ...
  .limit(2)
  .select()
  console.log('we reached line 73 delSupabaseMulti')
