(function () {
  ...
  (self["webpackChunkdev1"] = self["webpackChunkdev1"] || []).push([["main"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_utils_apiRat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/utils/apiRat */
      9556); // import { isError } from 'util'
      ...
      var _AppComponent = /*#__PURE__*/function () {
        function _AppComponent() {
          ...
          this.title = 'playground for FlyTechFree'; //initialCountInAppComponent: number = 10;
          ...
          this.supaMsg = ''; // title = environment.title
        ...
        _createClass(_AppComponent, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 10:
                      ...
                      _context.next = 13;
                      return this.supaRead('todoList', 'todoTxt', 'rain', 1);

                    case 13:
                      waitForIt = _context.sent;
                      _context.next = 16;
                      return this.supaRead('guitars', 'guitarType', 'acoustic', 7);

                    case 16:
                      waitForIt = _context.sent;
                      console.log(Date.now(), 'bottom of ngOnInit'); //this.setUrlFileName()
          ...
          key: "parentFun2",
          value: function parentFun2(event) {
            this.myCount = event;
            this.msgFromBeyond = 'msg from parentFun2';
          }
        }, {
          key: "parentFun1",
          value: function parentFun1(myFriendParmIn) {
            this.msgFromBeyond = " Msg from parentFun1 ";
            this.myFriend = myFriendParmIn;
          }
        }, {
          key: "parentFun3",
          value: function parentFun3(gdaParmIn) {
          ...
          value: function tryTruck() {
            ...
            var rows = [[55, 'Bob', new Date(), this.totemText], [66, 'Ed', new Date(), 'blaBlaBla'], [77, 'Ron', new Date()], [88, 'Ken', new Date()]]; // add new rows and return them as array of row objects
          ...
          key: "supaRead",
          value: function supaRead(tableNameParmIn, colNameParmIn, colValParmIn, limitParmIn) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var eMsg, _yield$this$supaClien, supaDataOut, error, cloner, myArray, myColNames, k, myColVals, jj, i;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      eMsg = '';
                      _context2.next = 4;
                      return this.supaClient.from(tableNameParmIn).select('*').limit(limitParmIn).eq(colNameParmIn, colValParmIn);

                    case 4:
                      _yield$this$supaClien = _context2.sent;
                      supaDataOut = _yield$this$supaClien.data;
                      error = _yield$this$supaClien.error;
                    ...
                    case 14:
                      ...
                      cloner = function cloner(x) {
                        return x;
                      };

                      myArray = supaDataOut.map(cloner);
                      ...
                      this.supaMsg = 'no data found for: ' + tableNameParmIn + ' ' + colNameParmIn + ' ' + colValParmIn;
                      return _context2.abrupt("return");

                    case 19:
                      // myArray myArray.length means we found at least one supabase rec.
                      this.supaMsg += ' *** ' + tableNameParmIn + ' ';
                      myColNames = Object.keys(myArray[0]);

                      for (k = 0; k < myArray.length; k++) {
                        myColVals = Object.values(myArray[k]);
                        console.log(Object.values(myArray[k]));

                        for (jj = 0; jj < myColNames.length; jj++) {
                      ...
                      i = myColNames.findIndex(function (c) {
                        return c == colNameParmIn;
                      });
                      console.log('282 no error with supaRead');

                    case 24:
                      console.log(Date.now(), 'bottom of supaRead'); // .eq(colNameParmIn,"eat a dumptruck full of chocolate")
      ...
      _AppComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        ...
        decls: 40,
        vars: 6,
        consts: [[1, "hero", "is-primary"], [1, "subtitle"], [1, "subtitley"], [1, "columns"], [1, "column"], [1, "label"], ["readonly", "", "type", "text", 1, "inputy"], ["id", "tryTruck", 1, "tag", "is-small", "is-info", "m-1", "is-clickable", 3, "click"], ["cols", "166", "rows", "11"]],
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function AppComponent_Template_span_click_34_listener() {
              return ctx.tryTruck();
            });
